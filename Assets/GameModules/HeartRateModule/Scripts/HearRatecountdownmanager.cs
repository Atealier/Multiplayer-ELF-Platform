...
public class HeartRatecountdownmanager : MonoBehaviour
{
    ...
    private IEnumerator ScaleChildren()
    {
        ...
        HearRateGameManager.GetComponent<HeartRateGameManager>().StartCountdown();
