...
public class countdownmanager : MonoBehaviour
{
    ...
    public GameObject saccademanager;

    private void OnEnable()
    {
       
        saccademanager.GetComponent<ArrowSaccadeManager>().DisableAllArrows();
    ...
    private IEnumerator ScaleChildren()
    {
        ...
        Debug.LogWarning("PLAYING BG SOUND IN PLAYER");
        ...
        saccademanager.GetComponent<ArrowSaccadeManager>().StartCountdown();
        saccademanager.GetComponent<ArrowSaccadeManager>().RotateRandomArrow();
